...
class WeekMaxChart: UIView {
    ...
    func updateChart(values:[[String:CGFloat]]){
        ...
        for index in 0...6 {
            ...
            var doneAmount:CGFloat! = values[index]["doneAmount"]
            var expectAmount:CGFloat! = values[index]["expectAmount"]
    ...
    func getMaxElement(data:[[String:CGFloat]])->CGFloat {
        
        var maxValue:CGFloat = 0
        
        for index in 0...6 {
         
            if maxValue < data[index]["doneAmount"]! {
                maxValue = data[index]["doneAmount"]!
            }
            
            if maxValue < data[index]["expectAmount"]!{
                maxValue = data[index]["expectAmount"]!
            }
