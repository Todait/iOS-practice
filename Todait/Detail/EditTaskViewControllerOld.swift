...
class EditTaskViewControllerOld: BasicViewController,UITextFieldDelegate,TodaitNavigationDelegate,CategoryDelegate,UITableViewDelegate,UITableViewDataSource,settingTimeDelegate,PeriodDelegate,InvestDelegate{
    ...
    func setupData(){
        ...
        investData = editedTask.week.getExpectedAmount() as! [Int]
    ...
    */
    ...
    func addEditButton(){
        ...
        editButton.setBackgroundImage(UIImage.maskColor("done@3x.png",color:UIColor.whiteColor()), forState: UIControlState.Normal)
        editButton.addTarget(self, action: Selector("editTask"), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func editTask(){
        ...
        case 0:
            editedTask.amount = totalTextField.text.toInt()!
            editedTask.start_point = 0
        case 1:
            editedTask.amount = endRangeTextField.text.toInt()! - startRangeTextField.text.toInt()! + 1
            editedTask.start_point = startRangeTextField.text.toInt()! + 1
        case 2:
            editedTask.amount = dayTextField.text.toInt()!
            editedTask.start_point = 0
        default:
            editedTask.amount = 0
        }
