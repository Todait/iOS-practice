...
- (NSString *)toolbarTitle
{
    ...
    {
        return [NSString stringWithFormat:NSLocalizedStringFromTable(@"", @"GMImagePicker", @"%@ Items Selected" ), @(nImages+nVideos)];
    }
    else if (nImages>1)
    {
        return [NSString stringWithFormat:NSLocalizedStringFromTable(@"", @"GMImagePicker", @"%@ Photos Selected"), @(nImages)];
    }
    else if (nImages==1)
    {
        return NSLocalizedStringFromTable(@"", @"GMImagePicker", @"1 Photo Selected" );
    }
    else if (nVideos>1)
    {
        return [NSString stringWithFormat:NSLocalizedStringFromTable(@"", @"GMImagePicker", @"%@ Videos Selected"), @(nVideos)];
    }
    else if (nVideos==1)
    {
        return NSLocalizedStringFromTable(@"", @"GMImagePicker", @"1 Video Selected");
    }
    else
    {
        return nil;
